...
export class Employee extends Component {
    ...
    refreshList() {
        ...
        fetch('https://localhost:44371/Employee/GetEmployee')
    ...
    createClick() {
        ...
        fetch('https://localhost:44371/Employee/AddEmployee', {
    ...
    updateClick() {
        ...
        fetch('https://localhost:44371/Employee/UpdateEmployee', {      
            method: 'PUT',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
    ...
    deleteClick(id) {
        if (window.confirm('Are you sure?')) {
            ...
            fetch('https://localhost:44371/Employee/DeleteEmployee/'  + id, {
