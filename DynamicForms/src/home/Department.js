...
export class Department extends Component {
    ...
    refreshList() {
        ...
        fetch('https://localhost:44371/Department/getdepartment')
        //fetch('http://localhost:8082/Department/getdepartment')
    ...
    createClick() {
        fetch('https://localhost:44371/Department/AddDepartment', {
    ...
    updateClick() {
        ...
        fetch('https://localhost:44371/Department/UpdateDepartment', {
            //fetch('http://localhost:8082/Department/UpdateDepartment' , {
            method: 'PUT',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
    ...
    deleteClick(id) {
        if (window.confirm('Are you sure?')) {
            ...
            fetch('https://localhost:44371/Department/DeleteDepartment/' + id, {
                //fetch('http://localhost:8082/Department/DeleteDepartment/' + id, {
                method: 'DELETE',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
...
//    constructor(props) {
//        super(props);
//        this.state = { department: [], loading: true };
//    }
...
//    static renderDepartmentTable(department) {
//        return (
...
//            ? <p><em>Loading...</em></p>
//            : FetchData.renderDepartmentTable(this.state.department);

//        return (
//            <div>
//                <h1 id="tabelLabel" >Deparment Data</h1>
...
//        this.setState({ department: data, loading: false });
//    }
//}
